<%-- 
    Document   : register
    Created on : 5 janv. 2019, 22:43:34
    Author     : karyn
--%>
...
<body>
	...
	<div  method="post" action="inscription" class="container-contact100">
		<div class="wrap-contact100">
			...
			<form method="post" action="inscription" class="contact100-form validate-form">
				<div class="wrap-input100 validate-input">
					...
					<label class="label-input100" for="prenom">
						<span class="lnr lnr-user m-b-2"></span>
                                ...
                                <div class="wrap-input100 validate-input">
					<input id="naissance" class="input100" type="date" name="naissance" placeholder="Date de naissance">
					<span class="focus-input100"></span>
					<label class="label-input100" for="naissance">
						<span class="lnr lnr-user m-b-2"></span>
					</label>
				</div>
				...
				<div class="wrap-input100 validate-input">
					...
					<label class="label-input100" for="email">
						<span class="lnr lnr-envelope m-b-5"></span>
                                 ...
                                 <div class="wrap-input100 validate-input">
					<input id="cp" class="input100" type="text" name="cp" placeholder="Ex. 83000">
					<span class="focus-input100"></span>
					<label class="label-input100" for="Code postal">
						<span class="lnr lnr-envelope m-b-5"></span>
					</label>
				</div>
				<div class="wrap-input100 validate-input">
					<input id="phone" class="input100" type="text" name="phone" placeholder="Ex. +33 000 000 000">
					<span class="focus-input100"></span>
					<label class="label-input100" for="phone">
						<span class="lnr lnr-smartphone m-b-2"></span>
                                 ...
                                 <div class="wrap-input100 validate-input">
					<input id="number" class="input100" type="number" name="number" placeholder="Nombre d'année(s) d'expérience">
					<span class="focus-input100"></span>
				...
				<div class="wrap-input100 validate-input">
					<textarea id="message" class="input100" name="message" placeholder="Quelles sont vos motvations"></textarea>
					<span class="focus-input100"></span>
